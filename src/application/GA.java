...
public class GA {
    ...
    // Applies ordered crossover to a set of parents and creates offspring
    public static Tour crossover(Tour parent1, Tour parent2) {
        ...
        else // else don't perform crossover and just copy parent 1
        {
    ...
    public static void setElitism(boolean flag)
    {
    	elitism = flag;
    }
}
